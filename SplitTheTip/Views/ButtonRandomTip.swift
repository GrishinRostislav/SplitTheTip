...
//MARK: - Preview
struct ButtonRandomTip_Previews: PreviewProvider {
    static var previews: some View {
        ButtonRandomTip(arrayOfPercentages: .constant([10, 15, 20, 25, 0]), selectedPercentage: .constant(20))
    }
}
